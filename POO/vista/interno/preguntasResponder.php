...
if(isset($_REQUEST['botonCerrar'])){
    ...
    header("Location:preguntasResponder.php?estadoFil=$a&fechaFil=$b");
}
    ...
    if(empty($_REQUEST['respuestaPregunta'])!=true){
        ...
        ?>
            ...
            Swal.fire({
                    ...
                    html:'<a class="btn btn-success" href="preguntasResponder.php" role="button">Aceptar</a> '
                    });
            </script>
        <?php
    }
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">My mutis | Responder Preguntas</p>
        </div>
    </div>
