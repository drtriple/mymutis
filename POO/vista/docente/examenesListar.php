...
$listar = $ControladorExam->listarExamenP($citador,$idAsigna);
...
if(isset($_REQUEST['botonEditar'])){
    ...
    <?php
    //header("Location:../../../POO/vista/docente/examenes.php");
				  ...
				  <div class="col-12 col-md-6 col-lg-6">
                                <label for="idGradoxGrupos" class="form-label">Grupo y grado:</label>
                                        <select class="form-select"  name="idGradoxGrupos" id="idGradoxGrupos">
                                            <option selected value="<?php echo $examA['idGradoxGrupos']?>"><?php echo $examA['grado']?> (Agendado)</option>
