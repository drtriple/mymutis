             ...
             <!--fin MODAL CREAR EVENTO-->       
                 ...
                 <div class="col-12 col-sm-12 col-md-6 col-xl-3 text-center">
								 ...
								 <div class="card" style="width: 100%;">
                                    ...
                                    <div class="row"><div class="col-6 col-md-12 col-lg-6 col-xl-6 col-xxl-6">      
                                            ...
                                            <?php if($e['idUsuarioCreador'] == $User->getidUsuario()){ ?>
                            <br><br></div><div class="col-6 col-md-12 col-lg-6 col-xl-6 col-xxl-6">        
