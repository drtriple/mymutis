...
if(isset($_SESSION['user'])){
  $logeado = $_SESSION['user'];
    ...
    $listargxg = $ControladorUsuario->unUsuariogxg($logeado);
...
<!--===============================================================================================-->
   ...
   <link href="../../../vendor/dasbord/mymutis.css" rel="stylesheet">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card-ID" id="carnet1">
                  ...
                  <h2 class="name"><?php echo $User->getnombresUsuarios() ?> <?php echo $User->getapellidosUsuarios() ?> | <?php echo $User->getidRolUsuario(); ?><br> CC: <?php echo $User->getdocUsuarios() ?></h2>
                  <div class="title">
                  <b>Director del grupo: </b>
                <?php foreach ($listargxg as $listargxga){
                   echo $listargxga['descGrado']."-".$listargxga['descGrupo'];
                  }
                   ?>  
                  <br>Correo Electrónico: <?php echo $User->getcorreoUsuarios() ?> </div>
                  <div class="actions">
                  <center>
                  ...
                  Docente de la Institución Educativa Jose Celestino Mutis. La IE José Celestino Mutis es una 
                  institución de carácter público que brinda los servicios educativos en los niveles de preescolar, 
                  básica y media técnica y académica, a través de un enfoque socio cognitivo - constructivista.
