...
if(isset($_SESSION['user'])){
    ...
    $listar = $ControladorExam->listarAsignaturas();
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-8 align-self-center">
                        <h3 class="text-themecolor">Exámenes - Asignaturas</h3>
                        <ol class="breadcrumb">
            ...
            <div class="row">
											<?php    foreach ($listar as $listAsis) {
												...
												?>
                 				<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-2">					 
						        <center>
		  ...
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="">
			  ...
			  <div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">Agendar examen</h4>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			  </div>
			  <div class="modal-body">	
			  	<div class="col-12 col-md-12 col-lg-12">
					<label for="descr" class="form-label">Título del examen: </label>
				  ...
				  <div class="col-12 col-md-6 col-lg-6">
					...
					<div class="col-12 col-md-6 col-lg-6">
                                <label for="idAsignaturas" class="form-label">Asignatura:</label>
			  ...
			  <div class="col-auto">
					<center>
					<button type="submit" class="btn btn-danger" name="botonAgregar">Agregar Examen</button>
