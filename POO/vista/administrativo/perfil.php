    ...
    if($User->getcorreoUsuarios()!=$_REQUEST['correo']){
        if(preg_match("/^[a-zA-Z0-9\._-]+@[a-zA-Z0-9-]{2,}[.][a-zA-Z]{2,4}$/", $_REQUEST['correo']) && empty($_REQUEST['correo'])!=true ){
            ...
            Swal.fire({
                             ...
                             '<a class="btn btn-success" href="perfil.php" role="button">Ok</a>'
                           });
                     </script>
             <?php
        }
...
if($User->getcontrasenaUsuarios()!=md5($_REQUEST['contrasena'])){
                       ...
                       <?php 
                        ...
                        ?>  
                           ...
                           <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic"
                               ...
                               <li><a class="dropdown-item" href="perfil.php?botonCerrar"><i class="fa fa-sign-in fa-lg"></i>&nbsp;Cerrar sesión</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                          ...
                          <center class="mt-4"> <img src="../../../images/fotosPerfil/<?php echo $image; ?>" class="img-circle"
                                    width="160" height="150" alt="perfil" />
                                ...
                                <form action="perfil.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <br><br>
                                    <button type="submit" class="btn btn-danger" name="btActualizarImagen">Actualizar imagen</button>
                                    </form>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal form-material mx-2">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class="btn btn-success" name="btActualizar">Actualizar perfil</button>
                                    </div>
                                </div>
                            </form>
                        </div>
