...
if(isset($_REQUEST['botonCrear'])){
    if($_REQUEST['idUsuarioCitado'] != 0 ){
        if($_REQUEST['FechaCita'] != "" && $_REQUEST['FechaCita'] >= $hoy){
    ...
    $c = $_REQUEST['docCitadoFil'];
    header("Location:citas.php?estadoFil=$a&fechaFil=$b&docCit=$c");
}
    ...
    if($_REQUEST['idEstadoCitaconclusion'] == 2){
          ...
          <BR>
               ...
               <div class="col-lg-12 col-md-12">
                <div class=" card card-body">
                        ...
                        <div class="col-12 col-sm-3 col-md-6 col-lg-3">
                            <label for="estadoFiltrar" class="form-label">Estado</label>
                                <select class="form-select" aria-label="Default select example" name="estadoFiltrar" id="estadoFiltrar">                   
                                        ...
                                        <option value="2">Desactivadas</option>
                                </select>
                        </div>
                        <div class="col-12 col-sm-3 col-md-6 col-lg-3">
                            <label for="fechaFiltrar" class="form-label">Fecha</label>
                            <input type="date" id="fechaFiltrar" name="fechaFiltrar" min="2022-01-01" max="2025-12-31" class="form-control">
                        </div>
                        <div class="col-12 col-sm-3 col-md-6 col-lg-3">
                            <label for="docCitadoFil" class="form-label">Documento estudiante</label>
                            <input type="text" id="docCitadoFil" name="docCitadoFil" class="form-control">                
                        </div>
                        <div class="col-12 col-sm-3 col-md-6 col-lg-3"><br>
                             <button class="btn btn-dark" style="width:100%;" name="btnFiltrar">Filtrar citas</button>
                        </div>   
                    </form>
                </div> 
            </div>
                    ...
                    if($_GET['estadoFiltrar'] != 0 && $_GET['fechaFiltrar'] == "" && $_GET['docCitadoFil'] == ""  ){
                        $listaCita = $ControladorCita->listarCitasEstado($_GET['estadoFiltrar']);
                    }
                    elseif($_GET['fechaFiltrar'] != "" && $_GET['estadoFiltrar'] == 0 && $_GET['docCitadoFil'] == "" ){
                        $listaCita = $ControladorCita->listarCitasFecha('"'.$_GET['fechaFiltrar'].'"');
                    }
                    elseif($_GET['docCitadoFil'] != "" && $_GET['estadoFiltrar'] == 0 && $_GET['fechaFiltrar'] == "" ){
                        $listaCita = $ControladorCita->listarCitasDocumento($_GET['docCitadoFil']);
                    }
                    else{
                    //LISTAS
                    $listaCita = $ControladorCita->listarCitas();
                        }
                     ?>	
               </div>
               <br>
                ...
                <div class="scroll_vertical">                    
                     <?php
                       ...
                       <div class="card-header bg-transparent"><div class="row">
                           ...
                           <div class="col-12 col-md-12 col-lg-4 col-xl-5 col-xxl-5"> <b>Fecha de la cita:</b> <?php echo $listarCitas['fecha'];?> / <b>Hora de la cita:</b> <?php echo $listarCitas['hora']; ?> </div>
                           <div class="col-12 col-md-6 col-lg-4 col-xl-5 col-xxl-6"> <b>Lugar:</b> I.E José Celestino Mutis </div>
...
<div class="modal-content">
  ...
  <form action="citas.php?idCitaEditar=<?php echo $listarCitas['idcita'];?>" method="POST">
                     ...
                     <input type="hidden"class="form-control" name="idUsuarioCitadoEditar" id="idUsuarioCitadoEditar" aria-describedby="helpId" value="<?php echo $listarCitas['citado'];?>" >
                            ...
                            <div class="col-12 col-md-12 col-lg-12">
                        <label for="idCitador" class="form-label">Citador:</label>
                        <input type="text"
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                            <label for="hora" class="form-label">Fecha de la cita:</label>
                            <input type="time"
                           ...
                           <div class="col-12 col-md-12 col-lg-12">
                           <label for="descr" class="form-label">Motivo de la Cita:</label>
